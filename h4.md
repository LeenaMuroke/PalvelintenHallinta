...
Oikeuksia en tässä kohti erikseen tarkistanut, sillä ne ovat samat kuin edellisessä tehtävässä. Toki oikeassa elämässä ne olisi hyvä aina tarkistaa, eikä olettaa. Menin takaisin scripts kansioon ja kopioin harjoitus2.sh tiedoston saltin tiedostoihin `sudo cp harjoitus2.sh /srv/salt/harjoitus2tila`. Tarkistin sen myös löytyvän nyt tilan tiedoista.
