...
Käynnistin Herran komennolla `sudo systemctl start salt-master.service`. Avasin avaimet `sudo salt-key`. Hyväksymättömistä avaimista löysin orjani. Hyväksyin sen komennolla `sudo salt-key -A`. Tarkistin uudestaan avaimet, ja orja on nyt hyväksyttynä. 
       ...
       leena2@Leenakone2:/srv/salt/apache$ sudo systemctl start salt-master.service
       leena2@Leenakone2:/srv/salt/apache$ sudo salt-key
       Accepted Keys:
       Denied Keys:
       Unaccepted Keys:
       Leenakone2
       Rejected Keys:
       leena2@Leenakone2:/srv/salt/apache$ sudo salt-key -A
       ...
       Unaccepted Keys:
       Rejected Keys:
       leena2@Leenakone2:/srv/salt/apache$ 
