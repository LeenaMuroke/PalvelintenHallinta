...
Nyt kokeilin ssh yhteyttä uudestaan komennolla `ssh leenam@10.0.2.15`. Pääsin sisälle. Lopuksi komennolla `exit` poistun ssh-yhteydestä.
 ...
 Eli ssh on nyt asennettuna ja saan yhteyden omalle koneelleni sen avulla. Tosin ideaalitilanne olisi käyttää tätä johonkin muuhun kuin omaan koneeseeni. 
